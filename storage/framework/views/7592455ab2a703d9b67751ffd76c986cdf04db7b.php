...
<?php $__currentLoopData = $recipe->ingridients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingrediant): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
<div class = "form-group">
<label for = "ingridients">Sastojak: <input name="ingridients[]" type="text" value="<?php echo e($ingridients->name); ?>"/></label>
